...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_ADJUST] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, EMPTY1,  EMPTY2,  _______, _______, _______,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    switch (keycode) {
        ...
        case EMPTY1:
            if (record->event.pressed) {
                set_single_persistent_default_layer(_EMPTY1);
            }
            return false;
        case EMPTY2:
            if (record->event.pressed) {
                set_single_persistent_default_layer(_EMPTY2);
            }
            return false;
    }
    return true;
